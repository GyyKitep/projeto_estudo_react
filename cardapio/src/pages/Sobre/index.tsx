  ...
  return (
    <section>
      ...
      <div className={style.sobreNos}>
        <img src={casa} alt="Casa Meu Cardápio" />
        <div className={style.sobreNos__texto}>
          <p>
            Nós do "Meu Cardápio" oferecemos a vocês, nossos queridos clientes, a Massa
          ...
          <p>
            Para acompanhar as massas italianas, "Meu Cardápio" possui uma reserva de
